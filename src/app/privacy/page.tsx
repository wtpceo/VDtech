    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="space-y-8 text-gray-700">
        <section>
          ...
          <p className="mb-4">주식회사 브이디텍(이하 '회사')은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.</p>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>서비스 이용 관련 정보: 서비스 종료 후 3년</li>
        ...
        <section>
          ...
          <p className="mb-4">파기절차 및 방법은 다음과 같습니다.</p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <ul className="mt-2 space-y-1">
              <li>성명: 홍길동</li>
              <li>직책: 개인정보 보호책임자</li>
              <li>연락처: 031-631-6191</li>
              <li>이메일: eddie00700@naver.com</li>
            </ul>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="mb-4">이 개인정보 처리방침은 2024년 1월 1일부터 적용됩니다. 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.</p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-4">10. 권익침해 구제방법</h2>
